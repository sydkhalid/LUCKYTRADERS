...
@section('content')
    <div class="mb-5 flex items-center justify-between">
        <div>
            <h2 class="text-lg font-semibold text-gray-900">Non-GST Sales Report</h2>
            <p class="text-sm text-gray-500">Normal bills stay separate from GST reports and auditor export.</p>
        </div>
    ...
    <div class="overflow-hidden rounded bg-white shadow">
        <table class="min-w-full divide-y divide-gray-200 text-sm">
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                @empty
                    <tr>
                        <td colspan="7" class="px-4 py-8 text-center text-gray-500">No non-GST sales found.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
