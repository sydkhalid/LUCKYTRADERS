...
@section('content')
    <div class="max-w-4xl">
        <div class="mb-5 flex items-center justify-between">
            <div>
                <h2 class="text-lg font-semibold text-gray-900">Create Expense Category</h2>
                <p class="text-sm text-gray-500">Use categories to group daily expenses and reports.</p>
            </div>
        ...
        <form method="POST" action="{{ route('expense-categories.store') }}" class="rounded bg-white p-6 shadow" data-ajax-form>
            @csrf
            ...
            <div class="mt-5">
                ...
                <textarea name="description" rows="3" class="w-full rounded border-gray-300 shadow-sm focus:border-slate-500 focus:ring-slate-500">{{ old('description') }}</textarea>
            </div>
