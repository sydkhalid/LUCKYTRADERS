    ...
    <div class="rounded bg-white p-6 shadow">
        <div class="grid gap-5 md:grid-cols-3">
            ...
            <div>
                ...
                <p class="mt-1 text-gray-900">₹ {{ number_format((float) $customer->opening_balance, 2) }} {{ ucfirst($customer->balance_type) }}</p>
            </div>
            <div>
                <p class="text-xs font-semibold uppercase text-gray-500">Current Balance</p>
                <p class="mt-1 text-gray-900">₹ {{ number_format((float) $customer->current_balance, 2) }}</p>
            </div>
            <div>
