...
@section('content')
    <div class="mb-5 flex items-center justify-between">
        <div>
            ...
            <p class="text-sm text-gray-500">Current balance: Rs. {{ number_format((float) $supplier->current_balance, 2) }}</p>
        </div>
        <a href="{{ route('ledgers.suppliers.index') }}" class="rounded border border-gray-300 px-4 py-2 text-sm font-semibold text-gray-700 hover:bg-gray-50">Back</a>
    </div>
