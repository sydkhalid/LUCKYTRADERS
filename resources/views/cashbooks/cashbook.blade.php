...
@section('content')
    ...
    <form method="GET" action="{{ route('cashbook.index') }}" class="mb-5 rounded bg-white p-5 shadow">
        <div class="grid grid-cols-1 gap-4 md:grid-cols-4">
            ...
            <div class="flex items-end">
                <a href="{{ route('cashbook.index') }}" class="w-full rounded border border-gray-300 px-4 py-2 text-center text-sm font-semibold text-gray-700 hover:bg-gray-50">Reset</a>
            </div>
        </div>
    </form>
