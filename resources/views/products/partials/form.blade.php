...
<form method="POST" action="{{ $action }}">
    ...
    <div class="grid grid-cols-1 gap-5 md:grid-cols-3">
        <div>
            ...
            <select name="product_category_id" class="w-full rounded border-gray-300 shadow-sm focus:border-slate-500 focus:ring-slate-500" required>
        ...
        <div>
            <label class="mb-1 block text-sm font-medium text-gray-700">Weight Per Unit</label>
        ...
        <div>
            <label class="mb-1 block text-sm font-medium text-gray-700">GST %</label>
        ...
        <div>
            <label class="mb-1 block text-sm font-medium text-gray-700">Opening Stock</label>
