    ...
    <main class="mx-auto max-w-5xl bg-white p-8 shadow print:shadow-none">
        ...
        <section class="mt-6 grid grid-cols-1 gap-5 md:grid-cols-2">
            ...
            <div class="rounded border border-gray-200 p-4">
                ...
                <p class="text-sm text-gray-700">Refund Received: <span class="font-semibold">Rs. {{ number_format((float) $return->refund_amount, 2) }}</span></p>
                <p class="text-sm text-gray-700">Payable Adjusted: <span class="font-semibold">Rs. {{ number_format((float) $return->adjustment_amount, 2) }}</span></p>
            </div>
        </section>
